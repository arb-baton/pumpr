...
async function stampContractAddressOnImage(sourceUrl, tokenAddress) {
  ...
  try {
    ...
    context.drawImage(bitmap, Math.round((1200 - width) / 2), Math.round((1200 - height) / 2), width, height);
    context.textAlign = "center";
    context.textBaseline = "alphabetic";
    context.font = `${tokenAddress.length > 44 ? 15 : 16}px 'Courier New', monospace`;
    context.lineWidth = 3;
    context.strokeStyle = "rgba(0, 0, 0, 0.9)";
    context.strokeText(`CA: ${tokenAddress}`, 600, 1174);
    context.fillStyle = "rgba(255, 255, 255, 0.92)";
    context.fillText(`CA: ${tokenAddress}`, 600, 1174);
